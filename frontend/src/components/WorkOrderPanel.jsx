...
export default function WorkOrderPanel({ onSaved }) {
  ...
  const prevWeekKey = sortedKeys[1];
    ...
    <div style={{ marginBottom: 24 }}>
      ...
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 16 }}>
        <div>
          ...
          <p style={{ fontSize: 12, color: "#888", margin: 0 }}>Track weekly work orders and defects</p>
        </div>
      ...
      <button
        ...
        style={{
          ...
          cursor: "pointer", fontFamily: "inherit", marginBottom: showHistory ? 16 : 0,
        }}>
      ...
      {showHistory && sortedWeeks.length === 0 && (
        <p style={{ fontSize: 13, color: "#aaa", textAlign: "center", padding: 24 }}>No work orders yet.</p>
      )}
