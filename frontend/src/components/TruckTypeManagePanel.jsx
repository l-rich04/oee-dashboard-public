...
const TruckTypeManagePanel = forwardRef(function TruckTypeManagePanel({ onChanged }, ref) {
  ...
  async function handleAdd() {
    ...
    setError(null);
    try {
      await createTruckType(newName.trim());
      setNewName("");
      load();
    ...
    <div onClick={e => { if (e.target === e.currentTarget) setOpen(false); }} style={{
      ...
      <div style={{
        ...
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 20 }}>
          <p style={{ fontSize: 15, fontWeight: 500, margin: 0 }}>Manage Truck Types</p>
...
export default TruckTypeManagePanel;